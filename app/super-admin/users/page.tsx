...
interface UserRow {
  ...
  role: string; status: string; country_name: string | null; institution_name: string | null
...
export default function SuperAdminUsersPage() {
  ...
  async function load() {
    ...
    // Load country and institution names separately
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-sand-300 overflow-hidden">
          <table className="rt w-full">
            ...
            <tbody>
              {filtered.length === 0 ? (
                <tr><td colSpan={5} className="text-center py-10 text-forest-300">No users found</td></tr>
              ) : filtered.map(u => {
                  ...
                  <tr key={u.id}>
                    <td>
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <div className="font-semibold text-[12.5px] text-forest-700">
                            {u.full_name || '—'}
                          </div>
                    ...
                    <td>
                      {/* Role dropdown — super admin can change any role */}
